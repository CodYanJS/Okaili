...
class Whitelist {
     ...
     * @param {Object} json A JSON object representing an Artifact.
     * 
     * @returns {Whitelist} The parsed Artifact.
     */
    static fromJSON(json){
        return Object.assign(new Whitelist(), json)
    }
...
class Module {
    ...
    static fromJSON(json, serverid){
        return new Module(json.Whitelist, json.id, json.name, json.type, json.required, json.artifact, json.subModules, serverid)
    }
    ...
    constructor(whitelist, id, name, type, required, artifact, subModules, serverid) {
        this.identifier = id
        this.type = type
        ...
        this.whitelist = Whitelist.fromJSON(whitelist)
...
exports.pullRemote = function(){
    ...
    return new Promise((resolve, reject) => {
       //const distroURL = 'http://localhost:80/dev-distro/distribution.json'
        const distroURL = 'http://codearth.fr/launcher/files/distro/distribution.json'
