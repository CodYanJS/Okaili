...
remote.getCurrentWebContents().on('devtools-opened', () => {
    console.log('%cACCES INTERDIT', 'color: white; -webkit-text-stroke: 4px #a02d2a; font-size: 60px; font-weight: bold')
    console.log('La grotte noir et sombre est interdite.', 'font-size: 16px')
    console.log('%c  ... DANGER DE MORT', 'font-size: 16px')
})
